...
object caseclassPoint extends App 
{
    ...
    println("The result of the addition of two points a and b:"+c) // add a and b points.

    a.move(x = 2, y = 4)// move from these.
    println("The result of moving coordinates from (2,4):"+a)
    
    var d = a.distance(b)// calculate distance between a and b points. a point is (5,8) now because of moving.
    println("The distance between a and b points:"+d)
